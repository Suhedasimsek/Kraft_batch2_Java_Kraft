...
class main{
    public static void main(String[] args) {
        ...
        Outer.Inner selam = outer.new Inner(); // bir üst satırda create edilmiş /outer/ nesnesi ile /new Inner()/  Inner class dan bir nesne create ediliyor. Nesnenin ismi /selam/ Nesnenin tipi Outer.Inner
