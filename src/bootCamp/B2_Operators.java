...
public class B2_Operators {
    public static void main(String[] args) {
        ...
        int value2 = 5;
        value2--;//postfix increment//5
        System.out.println("value2 = " + value2);//4
        --value2;//prefix increment//3
        System.out.println("value2 = " + value2--);//3

        int i2 = value2 + 0;//value2 = 2
...
//        System.out.println(t %= j);//   10/0   aritmethic exception
        ...
        //All of above represent boolean condition // true yada false ifade eder
